...
public abstract class BaseEntityService<E, B, I, R extends JpaRepository<E, UUID>> {
    ...
    abstract B convertEntityToBean(E entity);

    abstract E convertBeanToEntity(B bean);

    abstract B convertRequestBeanToEntityBean(I inputBean);

    abstract void prepareEntityBeforeSave(E entity, I inputBean);
